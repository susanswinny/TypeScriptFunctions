...
var product1 = new Product('milk', 2.44);
var product2 = new Product('oranges', 4.55);
...
var Email = (function () {
    function Email(from, to, subject) {
        this.from = from;
        this.to = to;
...
var Cheeseburger = (function (_super) {
    ...
    function Cheeseburger(name) {
        var _this = _super.call(this, name) || this;
        _this.name = name;
        _this.name = 'Cheeseburger';
        return _this;
    }
